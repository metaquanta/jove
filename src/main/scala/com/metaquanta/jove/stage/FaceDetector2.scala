 ...
 */
class FaceDetector2  extends Stage {
  val faceCascade = new CascadeClassifier()
  println("CascadeClassifier.load(lbpcascade_frontalface): " + faceCascade.load("src/main/resources/lbpcascades/lbpcascade_frontalface.xml"))
