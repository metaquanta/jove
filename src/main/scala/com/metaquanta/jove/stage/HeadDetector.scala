 ...
 */
class HeadDetector  extends Stage {
  val faceCascade = new CascadeClassifier()
  println("CascadeClassifier.load(lbpcascade_profileface): " + faceCascade.load("src/main/resources/lbpcascades/lbpcascade_profileface.xml"))
